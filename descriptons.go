...
var tile_32_short = ``
var tile_32_description = `Stepping through the moss-laden stones, you emerge from the emerald embrace of the twilight grove. Sunlight, dappled and warm, 
filters through the canopy overhead, painting the forest floor in a mosaic of light and shadow. The oppressive mist that shrouded the grove like a spectral veil thins and dissipates, 
revealing a world reborn in vibrant hues.  Gone are the gnarled branches clawing at the sky, replaced by a cathedral of towering trees. 
...
A carpet of wildflowers, a kaleidoscope of amethyst and saffron, stretches before you. Butterflies, their wings like stained glass windows, flit from bloom to bloom, 
their vibrant colors a stark contrast to the muted tones of the grove. A gentle breeze stirs the emerald sea, sending ripples of color dancing across the floral expanse.
In the distance, a crystalline stream meanders through the glade, its surface a mirror reflecting the azure sky above. Sunlight dances on the water, 
transforming it into a liquid tapestry of diamonds and sapphires. The gurgle of its current mingles with the birdsong, creating a melody that soothes the soul.
A path, worn smooth by the tread of countless unseen feet, beckons you deeper into the sun-dappled heart of the glade. 
The ancient stones that pave its way are etched with cryptic symbols, their meaning lost to the ages yet pulsing with an undeniable magic. 
The air here crackles with an unseen energy, a whispered promise of adventure that sets your heart racing with anticipation.
As you step onto the path, the sunlight warms your skin, chasing away the lingering chill of the grove. You take a deep breath, the fresh, sweet air filling your lungs,
 and a sense of wonder washes over you. This is no ordinary glade; it is a portal to a world of vibrant life, ancient secrets, and endless possibilities.
It's then, with the first tentative steps on this sunlit haven, that a flicker of recognition ignites within. A spark in the fog-choked memory that once held your past. 
...
it's a realm beyond the veil, a land of the ever-after.
A strange calmness washes over you. Fear, perhaps, should gnaw at the edges of your being, yet an undeniable acceptance takes hold. The sun warms your skin, not with mere light, 
but with a gentle understanding. The rustling leaves whisper not secrets, but echoes of countless souls who have passed before. Perhaps this death is not an ending, but a homecoming, 
a transition into a new chapter of existence, whispered about in hushed tones throughout life's fleeting moments.
With newfound clarity, you stand tall, not in defiance of your fate, but in humble acceptance. This glade, bathed in eternal sunlight, may not be the world you knew, 
but it is yours to explore, to understand. The ancient path beckons, not with promises of earthly destinations, but with the whispers of untold mysteries, 
tales woven from the fabric of eternity itself. This is not a path you fear, but one you embrace, a first step into an existence unbound by the limitations of mortal clay.
The sun shines bright, not just on the glade, but on your newly awakened soul. You raise your head, a smile gracing your lips. This is not an end, but an endless beginning, 
a chance to dance in the sunlit glade of forever. It's time to walk the path, not with the trepidation of the lost, but with the curiosity of the explorer, the wonder of the awakened.`
